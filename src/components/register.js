    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-blue-500 p-4 w-full text-4xl lg:text-lg">
            <div className="bg-white w-full rounded shadow-2xl p-4 md:p-8 lg:p-16 mx-2 sm:mx-4 md:mx-20 lg:max-w-xl">
                ...
                <p className="mt-8 text-center text-2xl">  邀请码获取请查看 <a src="https://aaron404.com/zh/eac-log/%E4%B8%80%E4%B8%AA%E7%AE%80%E7%9F%AD%E7%9A%84%E9%82%80%E8%AF%B7/" className="text-blue-500 hover:text-blue-700">这个说明</a>.</p>
            </div>
        </div>
    );
};
