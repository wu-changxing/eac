...
const InvitedUsersCard = () => {
    ...
    return (
        <div className="m-2 md:m-4 mt-4 md:mt-16 p-2 md:p-4 text-lg md:text-xl bg-white rounded-lg shadow-lg transform transition-all ease-in-out duration-350 w-full md:max-w-md text-center">
